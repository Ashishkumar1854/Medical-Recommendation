...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white transition-all duration-700">
      ...
      {!result && (
        ...
        >
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6">
            AI Medical <span className="text-green-400">Symptoms Checker</span>
          </h1>
          ...
          {/* Input Form Card */}
          <motion.div
            className="max-w-lg mx-auto bg-gray-900/80 backdrop-blur-xl border border-gray-700 shadow-2xl rounded-3xl p-6 md:p-8 hover:border-green-400/60 transition-all duration-300"
      ...
      {result && (
        <motion.div
          key="result-section"
          className="w-full min-h-screen bg-white text-gray-800 flex flex-col items-center justify-start py-16 px-4 md:px-10 overflow-y-auto"
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <button
            ...
            className="mt-10 px-6 py-3 bg-gradient-to-r from-blue-600 to-green-500 text-white font-semibold rounded-full shadow-lg hover:scale-105 transition"
          >
